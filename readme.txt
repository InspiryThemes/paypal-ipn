...
= 1.1.6 - 12.08.2018 =
* Feature - Adds the ability to purge old IPN data, and the option to remove ALL data on uninstall. ([PIFW-11](https://bitbucket.org/angelleye/paypal-ipn-for-wordpress/pull-requests/5))

= 1.1.5 - 08.18.2018 =
* Tweak - Skips updating the IPN data record if an unverified IPN is sent after an original IPN. ([PIFW-1](https://bitbucket.org/angelleye/paypal-ipn-for-wordpress/pull-requests/4/pifw-1/diff))

= 1.1.4 - 06.21.2018 =
* Tweak - Replaces remote resources with local copies, and further data sanitization for privacy and security. ([PIFW-7](https://bitbucket.org/angelleye/paypal-ipn-for-wordpress/pull-requests/3))

= 1.1.3 - 06.20.2018 =
* Tweak - Adds data sanitization and replaces remote resources with local copies. ([PIFW-2](https://bitbucket.org/angelleye/paypal-ipn-for-wordpress/pull-requests/1))
* Fix - Resolves an issue with data tables displayed using shortcodes. ([PIFW-3](https://bitbucket.org/angelleye/paypal-ipn-for-wordpress/pull-requests/2))
